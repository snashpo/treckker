...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  } /* if ((*(uint32_t*)&TIMx == TIM1_BASE) || (*(uint32_t*)&TIMx == ... */
...
void TIM_ICInit(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct)
{
  ...
  } else { /* if (TIM_ICInitStruct->TIM_Channel == TIM_Channel_1) */
...
void TIM_PWMIConfig(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct)
{
  ...
  } else { /* if (TIM_ICInitStruct->TIM_ICPolarity == TIM_ICPolarity_Rising) */
  ...
  } else { /* if (TIM_ICInitStruct->TIM_ICSelection == TIM_ICSelection_... */
    icoppositeselection = TIM_ICSelection_DirectTI;
  } /* if (TIM_ICInitStruct->TIM_ICSelection == TIM_ICSelection_... */
                                ...
                                uint16_t TIM_ICPolarity, uint16_t ICFilter)
{
  ...
  } else { /* if (TIM_TIxExternalCLKSource == TIM_TIxExternalCLK1Source_TI2) */
		    ...
		    uint16_t TIM_OCMode)
{
  ...
  if ((TIM_Channel == TIM_Channel_1) ||(TIM_Channel == TIM_Channel_3)) {
    ...
    *((__IO uint32_t *)
      ((*(uint32_t*)&TIMx) + CCMR_Offset + (TIM_Channel>>1))) &= 
      CCMR_OC13M_Mask;
    
    /* Configure the OCxM bits in the CCMRx register */
    *((__IO uint32_t *)
      ((*(uint32_t*)&TIMx) + CCMR_Offset + (TIM_Channel>>1))) |= TIM_OCMode;

  } else { /* if ((TIM_Channel == TIM_Channel_1) ||(TIM_Channel == ... */

    /* Reset the OCxM bits in the CCMRx register */
    *((__IO uint32_t *)
      ((*(uint32_t*)&TIMx) + CCMR_Offset + ((uint16_t)(TIM_Channel - 4)>> 1))) 
      &= CCMR_OC24M_Mask;
  ...
  } /* if ((TIM_Channel == TIM_Channel_1) ||(TIM_Channel == ... */
...
void TIM_UpdateRequestConfig(TIM_TypeDef* TIMx, uint16_t TIM_UpdateSource)
{
  ...
  } else { /* if (TIM_UpdateSource != TIM_UpdateSource_Global) */
    /* Reset the URS Bit */
...
{ 
  ...
  if ((TIMx->SR & TIM_FLAG) != (uint16_t)RESET) {
    bitstatus = SET;
  } else { /* if ((TIMx->SR & TIM_FLAG) != (uint16_t)RESET) */
    bitstatus = RESET;
  } /* if ((TIMx->SR & TIM_FLAG) != (uint16_t)RESET) */
...
ITStatus TIM_GetITStatus(TIM_TypeDef* TIMx, uint16_t TIM_IT)
{
  ...
  if ((itstatus != (uint16_t)RESET) && (itenable != (uint16_t)RESET)) {
    bitstatus = SET;
  } else { /* if ((itstatus != (uint16_t)RESET) && (itenable != ... */
    bitstatus = RESET;
  } /* if ((itstatus != (uint16_t)RESET) && (itenable != ... */
