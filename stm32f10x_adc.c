...
FlagStatus ADC_GetResetCalibrationStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_RSTCAL_Set) != (uint32_t)RESET) {
    /* RSTCAL bit is set */
    bitstatus = SET;
  } else { /* if ((ADCx->CR2 & CR2_RSTCAL_Set) != (uint32_t)RESET) */
    /* RSTCAL bit is reset */
    bitstatus = RESET;
  } /* if ((ADCx->CR2 & CR2_RSTCAL_Set) != (uint32_t)RESET) */
...
FlagStatus ADC_GetCalibrationStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_CAL_Set) != (uint32_t)RESET) {
    ...
    bitstatus = SET;
  } else { /* if ((ADCx->CR2 & CR2_CAL_Set) != (uint32_t)RESET) */ 
...
void ADC_SoftwareStartConvCmd(ADC_TypeDef* ADCx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    /* 
     * Enable the selected ADC conversion on external event and start 
     * the selected ADC conversion 
     */
    ADCx->CR2 |= CR2_EXTTRIG_SWSTART_Set;
  } else { /* if (NewState != DISABLE) */
    /* 
     * Disable the selected ADC conversion on external event and stop 
     * the selected ADC conversion 
     */
...
FlagStatus ADC_GetSoftwareStartConvStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_SWSTART_Set) != (uint32_t)RESET) {
    /* SWSTART bit is set */
    bitstatus = SET;
  } else { /* if ((ADCx->CR2 & CR2_SWSTART_Set) != (uint32_t)RESET) */
...
FlagStatus ADC_GetSoftwareStartInjectedConvCmdStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & CR2_JSWSTART_Set) != (uint32_t)RESET) {
    /* JSWSTART bit is set */
    bitstatus = SET;
  } else { /* if ((ADCx->CR2 & CR2_JSWSTART_Set) != (uint32_t)RESET) */
					...
					uint8_t ADC_InjectedChannel)
{
  ...
  return (uint16_t) (*(__IO uint32_t*) (((*(uint32_t*)&ADCx) + 
					 ADC_InjectedChannel + JDR_Offset)));
}
...
FlagStatus ADC_GetFlagStatus(ADC_TypeDef* ADCx, uint8_t ADC_FLAG)
{
  ...
  if ((ADCx->SR & ADC_FLAG) != (uint8_t)RESET) {
    /* ADC_FLAG is set */
    bitstatus = SET;
  } else { /* if ((ADCx->SR & ADC_FLAG) != (uint8_t)RESET) */
    /* ADC_FLAG is reset */
    bitstatus = RESET;
  } /* if ((ADCx->SR & ADC_FLAG) != (uint8_t)RESET) */
...
ITStatus ADC_GetITStatus(ADC_TypeDef* ADCx, uint16_t ADC_IT)
{
  ...
  if (((ADCx->SR & itmask) != (uint32_t)RESET) && enablestatus) {
    /* ADC_IT is set */
    bitstatus = SET;
  } else { /* if (((ADCx->SR & itmask) != (uint32_t)RESET) && enablestatus) */
    /* ADC_IT is reset */
    bitstatus = RESET;
  } /* if (((ADCx->SR & itmask) != (uint32_t)RESET) && enablestatus) */
