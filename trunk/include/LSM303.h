...
#define LSM_Acc_ODR_50                          ((uint8_t)0x00)
#define LSM_Acc_ODR_100                         ((uint8_t)0x08)
#define LSM_Acc_ODR_400                         ((uint8_t)0x10)
#define LSM_Acc_ODR_1000                        ((uint8_t)0x18)
...
*/
#define LSM_A_ADDRESS         0x30		//0x33 Check schematic for address pins config 
...
*/
#define LSM_M_ADDRESS         0x3C	// 0x3D Check schematic for address pin config 
