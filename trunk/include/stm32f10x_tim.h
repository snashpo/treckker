...
/*
 * OSSI:_Off-State_Selection_for_Idle_mode_states 
 */
...
/*
 * OSSR:_Off-State_Selection_for_Run_mode_states 
 */
...
#define IS_TIM_PERIPH_IT(PERIPH, TIM_IT)				\
  ((((((*(uint32_t*)&(PERIPH)) == TIM2_BASE)   ||			\
      ...
      (((*(uint32_t*)&(PERIPH)) == TIM4_BASE)) ||			\
      (((*(uint32_t*)&(PERIPH)) == TIM5_BASE)))) &&			\
    (((TIM_IT) & (uint16_t)0xFFA0) == 0x0000) &&			\
    ((TIM_IT) != 0x0000)) ||						\
   (((((*(uint32_t*)&(PERIPH)) == TIM1_BASE) ||				\
      (((*(uint32_t*)&(PERIPH)) == TIM8_BASE)))) &&			\
    (((TIM_IT) & (uint16_t)0xFF00) == 0x0000) &&			\
    ((TIM_IT) != 0x0000)) ||						\
   (((((*(uint32_t*)&(PERIPH)) == TIM6_BASE) ||				\
      (((*(uint32_t*)&(PERIPH)) == TIM7_BASE)))) &&			\
    (((TIM_IT) & (uint16_t)0xFFFE) == 0x0000) && \
    ((TIM_IT) != 0x0000)))
...
#define IS_TIM_PERIPH_EVENT(PERIPH, EVENT)				\
  ((((((*(uint32_t*)&(PERIPH)) == TIM2_BASE)       ||			\
      ...
      (((*(uint32_t*)&(PERIPH)) == TIM4_BASE))     ||			\
      (((*(uint32_t*)&(PERIPH)) == TIM5_BASE))))   &&			\
    (((EVENT) & (uint16_t)0xFFA0) == 0x0000)       &&			\
    ((EVENT) != 0x0000))                           ||			\
   (((((*(uint32_t*)&(PERIPH)) == TIM1_BASE)       ||			\
      (((*(uint32_t*)&(PERIPH)) == TIM8_BASE))))   &&			\
    (((EVENT) & (uint16_t)0xFF00) == 0x0000)       &&			\
    ((EVENT) != 0x0000))                           ||			\
   (((((*(uint32_t*)&(PERIPH)) == TIM6_BASE)       ||			\
      (((*(uint32_t*)&(PERIPH)) == TIM7_BASE))))   &&			\
    (((EVENT) & (uint16_t)0xFFFE) == 0x0000)       &&			\
    ((EVENT) != 0x0000)))
...
#define IS_TIM_CLEAR_FLAG(PERIPH, TIM_FLAG)				\
  ((((((*(uint32_t*)&(PERIPH)) == TIM2_BASE)       ||			\
   ...
   (((((*(uint32_t*)&(PERIPH)) == TIM6_BASE)       ||			\
      (((*(uint32_t*)&(PERIPH)) == TIM7_BASE))))   &&			\
    (((TIM_FLAG) & (uint16_t)0xFFFE) == 0x0000)    &&			\
    ((TIM_FLAG) != 0x0000)))
