...
/*
 * In the following line adjust the External High Speed oscillator 
...
/* STM32 does not provide a MPU present or not  */
...
/* Internal 8 MHz RC oscillator clock selected */
...
#define  RCC_APB2RSTR_AFIORST                ((uint16_t)0x0001)            

/* I/O port A reset */
#define  RCC_APB2RSTR_IOPARST                ((uint16_t)0x0004)            

/* IO port B reset */
#define  RCC_APB2RSTR_IOPBRST                ((uint16_t)0x0008)            

/* IO port C reset */
#define  RCC_APB2RSTR_IOPCRST                ((uint16_t)0x0010)            

/* IO port D reset */
#define  RCC_APB2RSTR_IOPDRST                ((uint16_t)0x0020)            

/* IO port E reset */
#define  RCC_APB2RSTR_IOPERST                ((uint16_t)0x0040)            

/* IO port F reset */
#define  RCC_APB2RSTR_IOPFRST                ((uint16_t)0x0080)            

/* IO port G reset */
#define  RCC_APB2RSTR_IOPGRST                ((uint16_t)0x0100)            

/* ADC 1 interface reset */
#define  RCC_APB2RSTR_ADC1RST                ((uint16_t)0x0200)            

/* ADC 2 interface reset */
#define  RCC_APB2RSTR_ADC2RST                ((uint16_t)0x0400)            

/* TIM1 Timer reset */
#define  RCC_APB2RSTR_TIM1RST                ((uint16_t)0x0800)            

/* SPI 1 reset */
#define  RCC_APB2RSTR_SPI1RST                ((uint16_t)0x1000)            

/* TIM8 Timer reset */
#define  RCC_APB2RSTR_TIM8RST                ((uint16_t)0x2000)            

/* USART1 reset */
#define  RCC_APB2RSTR_USART1RST              ((uint16_t)0x4000)            

/* ADC3 interface reset */
#define  RCC_APB2RSTR_ADC3RST                ((uint16_t)0x8000)            
...
/* CAN reset */
#define  RCC_APB1RSTR_CANRST                 ((uint32_t)0x02000000)        
...
#define  RCC_APB2ENR_AFIOEN                  ((uint16_t)0x0001)            

/* I/O port A clock enable */
#define  RCC_APB2ENR_IOPAEN                  ((uint16_t)0x0004)            

/* I/O port B clock enable */
#define  RCC_APB2ENR_IOPBEN                  ((uint16_t)0x0008)            

/* I/O port C clock enable */
#define  RCC_APB2ENR_IOPCEN                  ((uint16_t)0x0010)            

/* I/O port D clock enable */
#define  RCC_APB2ENR_IOPDEN                  ((uint16_t)0x0020)            

/* I/O port E clock enable */
#define  RCC_APB2ENR_IOPEEN                  ((uint16_t)0x0040)            

/* I/O port F clock enable */
#define  RCC_APB2ENR_IOPFEN                  ((uint16_t)0x0080)            

/* I/O port G clock enable */
#define  RCC_APB2ENR_IOPGEN                  ((uint16_t)0x0100)            

/* ADC 1 interface clock enable */
#define  RCC_APB2ENR_ADC1EN                  ((uint16_t)0x0200)            

/* ADC 2 interface clock enable */
#define  RCC_APB2ENR_ADC2EN                  ((uint16_t)0x0400)            

/* TIM1 Timer clock enable */
#define  RCC_APB2ENR_TIM1EN                  ((uint16_t)0x0800)            

/* SPI 1 clock enable */
#define  RCC_APB2ENR_SPI1EN                  ((uint16_t)0x1000)            

/* TIM8 Timer clock enable */
#define  RCC_APB2ENR_TIM8EN                  ((uint16_t)0x2000)            

/* USART1 clock enable */
#define  RCC_APB2ENR_USART1EN                ((uint16_t)0x4000)            

/* DMA1 clock enable */
#define  RCC_APB2ENR_ADC3EN                  ((uint16_t)0x8000)            
...
/* SPI1 remapping */
#define AFIO_MAPR_SPI1 _REMAP                ((uint32_t)0x00000001)        
...
/* 
 * No remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PB12, 
 * CH1N/PB13, CH2N/PB14, CH3N/PB15) 
 */
#define AFIO_MAPR_TIM1_REMAP_NOREMAP         ((uint32_t)0x00000000)        

/* 
 * Partial remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PA6, 
 * CH1N/PA7, CH2N/PB0, CH3N/PB1) 
 */
#define AFIO_MAPR_TIM1_REMAP_PARTIALREMAP    ((uint32_t)0x00000040)        

/* 
 * Full remap (ETR/PE7, CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15, 
...
/* 
 * It indicates that a pending interrupt becomes active in the next running 
 * cycle 
 */
...
/*
 * Thread mode can be entered from any level in Handler mode by controlled 
 * return value 
 */
#define  SCB_CCR_NONBASETHRDENA              ((uint16_t)0x0001)            

/* 
 * Enables user code to write the Software Trigger Interrupt register to 
...
/* 
 * On exception entry, the SP used prior to the exception is adjusted to be 
 * 8-byte aligned 
 */
...
/* 
 * Priority of system handler 4,8, and 12. Mem Manage, reserved and 
 * Debug Monitor 
 */
...
/* Trigger request occurred on the external interrupt line 18 */
...
#define  DBGMCU_CR_DBG_CAN_STOP              ((uint32_t)0x00004000)        
...
#define  DBGMCU_CR_DBG_TIM5_STOP             ((uint32_t)0x00020000)        

/* TIM6 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM6_STOP             ((uint32_t)0x00040000)        

/* TIM7 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM7_STOP             ((uint32_t)0x00080000)        

/* TIM8 counter stopped when core is halted */
#define  DBGMCU_CR_DBG_TIM8_STOP             ((uint32_t)0x00100000)        
...
/* Not used */
#define  FLASH_OBR_Notused                   ((uint16_t)0x03E0)            
