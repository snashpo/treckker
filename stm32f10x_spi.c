...
void I2S_Init(SPI_TypeDef* SPIx, I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  if (I2S_InitStruct->I2S_AudioFreq == I2S_AudioFreq_Default) {
    i2sodd = (uint16_t)0;
    i2sdiv = (uint16_t)2;   
  } else { /* if (I2S_InitStruct->I2S_AudioFreq == I2S_AudioFreq_Default) */
    /* 
    ...
    if (I2S_InitStruct->I2S_DataFormat == I2S_DataFormat_16b) {
      ...
      packetlength = 1;
    } else { /* if (I2S_InitStruct->I2S_DataFormat == I2S_DataFormat_16b) */
    ...
    } else { /* if (I2S_InitStruct->I2S_MCLKOutput == I2S_MCLKOutput_Enable) */
				   ...
				   uint16_t SPI_NSSInternalSoft)
{
  ...
  } else { /* if (SPI_NSSInternalSoft != SPI_NSSInternalSoft_Reset) */
...
FlagStatus SPI_I2S_GetFlagStatus(SPI_TypeDef* SPIx, uint16_t SPI_I2S_FLAG)
{
  ...
  if ((SPIx->SR & SPI_I2S_FLAG) != (uint16_t)RESET) {
    /* SPI_I2S_FLAG is set */
    bitstatus = SET;
  } else { /* if ((SPIx->SR & SPI_I2S_FLAG) != (uint16_t)RESET) */
...
ITStatus SPI_I2S_GetITStatus(SPI_TypeDef* SPIx, uint8_t SPI_I2S_IT)
{
  ...
  if (((SPIx->SR & itpos) != (uint16_t)RESET) && enablestatus) {
    /* SPI_I2S_IT is set */
    bitstatus = SET;
  } else { /* if (((SPIx->SR & itpos) != (uint16_t)RESET) && enablestatus) */
    /* SPI_I2S_IT is reset */
    bitstatus = RESET;
  } /* if (((SPIx->SR & itpos) != (uint16_t)RESET) && enablestatus) */
